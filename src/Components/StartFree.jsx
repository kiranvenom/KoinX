	...
	return (
		<div className='bg-[#0052FE] text-white flex flex-col items-center p-6 rounded-lg'>
			<h1 className='font-bold text-5xl text-center mb-6'>
				Get started with kninX for Free
			</h1>
			<p className='text-center'>
				Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa
				nam earum aliquam deleniti at odio molestias quos illum aperiam
				a adipisci eaque, qui esse quis inventore repudiandae sunt
				dolorum vel.
			</p>
			<img
